$(document).ready(function () {
    ...
    // CHOOSE NUMBER ORDER
    // var value = parseInt($("#num-order-wp .num-order").attr("value"));

    $("#num-order-detail-wp .plus").click(function () {
        var input_num = $(this).prev("input[name=num-order]");
        var value = parseInt(input_num.attr("value"));
        value++;
        // $("#num-order-wp .num-order").attr("value", value);
        input_num.attr("value", value);
    });
    $("#num-order-detail-wp .minus").click(function () {
        var input_num = $(this).next("input[name=num-order]");
        var value = parseInt(input_num.attr("value"));
        if (value > 1) {
            value--;
            // $("#num-order-wp .num-order").attr("value", value);
    ...
    $("#num-order-cart-wp .plus").click(function () {
        var input_num = $(this).prev("input[name=num-order]");
        var value = parseInt(input_num.attr("value"));
        value++;
        // $("#num-order-wp .num-order").attr("value", value);
    ...
    $("#num-order-cart-wp .minus").click(function () {
        var input_num = $(this).next("input[name=num-order]");
        var value = parseInt(input_num.attr("value"));
        if (value > 1) {
            value--;
